...
insert into exercises (id, name, primary_muscle) values
  ('EIeI8Vf','Press de banca con barra','chest')
on conflict (id) do nothing;
insert into training_blocks (id, student_id, name, total_weeks) values
  ('aaaaaaaa-0000-0000-0000-000000000003','aaaaaaaa-0000-0000-0000-000000000001','Bloque 01', 4);
insert into training_sessions (id, block_id, week_number, day_label, order_index) values
...
insert into session_exercises (session_id, exercise_id, order_index, sets, reps, load) values
  ('aaaaaaaa-0000-0000-0000-000000000004','EIeI8Vf',0,4,'8-10','60kg'),
  ('aaaaaaaa-0000-0000-0000-000000000005','EIeI8Vf',0,5,'5','70%');
insert into classes (id, trainer_id, name, weekday, start_time, capacity) values
...
select 'students'         as tabla, count(*) as visibles from students
union all select 'plans',             count(*) from plans
union all select 'memberships',       count(*) from memberships
union all select 'payments',          count(*) from payments
union all select 'payments_view',     count(*) from payments_with_status
union all select 'training_blocks',   count(*) from training_blocks
...
select count(*) as catalogo_global from exercises where owner_id is null;
...
declare n int;
begin
  update students set first_name = 'HACKEADO'
...
select duplicate_week('aaaaaaaa-0000-0000-0000-000000000003', 1, 9) as copiadas_por_B;

\echo '── 2c. dashboard_summary de B viene vacío ──'
select jsonb_pretty(dashboard_summary()) as dashboard_de_B;
...
select status, count(*) from payments_with_status group by status order by status;
...
do $$ begin
  insert into profiles (id, full_name) values ('11111111-1111-1111-1111-111111111111','Reparada');
...
do $$ begin
  insert into profiles (id, full_name) values ('33333333-3333-3333-3333-333333333333','Ajena');
...
do $$ begin
  insert into students (trainer_id, first_name, last_name)
...
\echo '── 4. duplicate_week copia sesiones y ejercicios ──'
select duplicate_week('aaaaaaaa-0000-0000-0000-000000000003', 1) as sesiones_copiadas;
...
do $$ begin
  perform duplicate_week('aaaaaaaa-0000-0000-0000-000000000003', 1, 2);
...
insert into students (id, trainer_id, first_name, last_name) values
...
do $$ begin
  insert into memberships (student_id, plan_id, price)
...
insert into exercises (id, owner_id, name, primary_muscle)
...
do $$ begin
  delete from exercises where id = 'c_test';
